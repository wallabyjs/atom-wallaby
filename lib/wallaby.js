...
class Wallaby {
  ...
  activate() {
    ...
    setImmediate(() => {
      ...
      if (Wallaby._isDebugMode() || Wallaby._noAutomaticInstallMode()) {
        Wallaby._download = () => {
    ...
    return Q.all([
      ...
      .then(([coreStat, pluginStat]) => {
        return Q.all([coreStat, pluginStat,
          (Wallaby._isDebugMode() || Wallaby._noAutomaticInstallMode() || hasJustUpdated || (fullInstall && coreStat && pluginStat))
            ? Q.when({
