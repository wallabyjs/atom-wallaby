...
class Wallaby {
  ...
  activate(state) {
    ...
    setImmediate(() => {
      ...
      self._statusBarTile = self._statusBar.addRightTile({item: statusElement, priority: Number.NEGATIVE_INFINITY});
      let statusUpdater = m => {
      ...
      Q.all([
        ...
        Wallaby._isDebugMode()
          ...
          : (statusUpdater('Downloading wallaby.js version file'), Wallaby._downloadAndExtract({
          name: 'version',
        ...
        .then(([coreStat, pluginStat, latestVersion]) => {
          ...
          if (!(coreStat && (require(corePackage).version === latestVersion.core))) {
            ...
            statusUpdater('Downloading and extracting wallaby.js core');
          }
          if (!(pluginStat && (require(pluginPackage).version === latestVersion.plugin))) {
            ...
            statusUpdater('Downloading and extracting wallaby.js Atom plugin');
          }
