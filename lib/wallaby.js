    ...
    setImmediate(() => {
      ...
      Q.all([
        ...
        Wallaby._isDebugMode()
          ? Q.when({core: require(self._corePackage).version, plugin: require(self._pluginPackage).version})
        ...
        .then(([coreStat, pluginStat, latestVersion]) => {
          ...
          self._coreVersion = require(self._corePackage).version;
          self._pluginVersion = require(self._pluginPackage).version;
          ...
          if (!(coreStat && (self._coreVersion === latestVersion.core))) {
            versions[0] = Wallaby._downloadAndExtract({
              ...
              to: path.dirname(self._corePackage),
              zip: true
            });
          ...
          if (!(pluginStat && (self._pluginVersion === latestVersion.plugin))) {
            versions[1] = Wallaby._downloadAndExtract({
              ...
              to: path.dirname(self._pluginPackage),
              zip: true
            });
        ...
        .then(() => {
          ...
          self._package = require(path.dirname(self._pluginPackage));
